...
const TWO_WAY_SPORT_RE = /(теннис|tennis|настольный теннис|table tennis|atp|wta|itf|итф|challenger|челленджер|utr|баскетбол|basket|нба|nba|евролига|euroleague|uleb|втб|vtb|cba|kbl|bbl|адриатическая|aba|израиль\. суперлига|волейбол|volley|бейсбол|baseball|mlb|afl|ufl|регби|rugby|mma|ufc|бокс|boxing|крикет|cricket|бадминтон|badminton|хоккей|hockey|nhl|хоккейбол|setka|сетка|лига про|liga pro|киберспорт|esports|lol|dota|counter-?strike|cs2|bo3|fc\s*26|nhl\s*26)/i;
