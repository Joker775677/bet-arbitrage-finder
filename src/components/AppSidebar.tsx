...
import { LayoutDashboard, Building2, Upload, Search, Target, Settings as SettingsIcon, TrendingUp, Radar, Zap, Flame, Globe } from "lucide-react";
import {
...
const items = [
  ...
  { title: "Двойной браузер", url: "/browser", icon: Globe },
