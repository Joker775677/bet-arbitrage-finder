...
import { LayoutDashboard, Building2, Upload, Search, Target, Settings as SettingsIcon, TrendingUp } from "lucide-react";
import {
...
const items = [
  ...
  { title: "Arbitrage Scanner", url: "/scanner", icon: Search },
